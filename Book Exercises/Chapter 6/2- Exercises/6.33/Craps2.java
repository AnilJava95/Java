   ...
   public static void main(String[] args)
   {
      ...
      while(true)
      {
         ...
         while (wager != 0)
         {
            ...
            if (wager <= 0)
               System.exit(0);
            // If wager is smaller or equal to bankBalance then this block is exited.
            // Else user keeps entering a wager until a valid wager is entered.
            if (!isBalanceEnough(wager))
            {
               System.out.println("Wager value bigger than bank balance. Please try "
                  + "again.");
               continue;
            }
            else
