 ...
 * Latest version: 17:06 30/06/2017.
 * Older versions: 
 */
...
public class HypotenuseCalculations
{
   public static void main(String[] args)
   {
      ...
      System.out.println("This program takes two side lengths of a right triangle "
         + "from user and calculates the hypotenuse.");
      ...
      while (side1 != 0)
      {
         ...
         System.out.printf("Side1 = %.2f, side2 = %.2f, hypotenuse = %.2f", side1, side2, 
            hypotenuse);
