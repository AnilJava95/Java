 ...
 * Latest version: 12:16 18/04/2017. Comments changed.
 * Older versions: 02:32 21/06/2016
 */
...
public class Statistics_for_the_Great_Pyramid_of_Giza
{
   public static void main(String[] args)
   {
      ...
      System.out.printf("%n%,.2f tons were built each year%n", totalWeight / builtTime);
      System.out.printf("%.2f tons were built each hour%n", totalWeight / builtTime / 365 / 24);
      System.out.printf("%.2f tons were built each minute%n", totalWeight / builtTime / 365 / 24 / 60);
   }
}